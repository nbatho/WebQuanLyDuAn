                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        {driveFile && (
                                            <div className="flex items-center gap-1.5 px-3 py-1 bg-[var(--color-primary-bg)] rounded-full text-caption font-semibold text-[var(--color-primary)] border border-[var(--color-primary-border)]">
                                                ...
                                                <X size={14} className="cursor-pointer hover:text-[var(--color-error)]" onClick={() => setDriveFile(null)} />
                                            </div>
                                        )}
                                    </div>
                                    <button onClick={handleSend}
                                        className={`flex cursor-pointer items-center gap-1.5 rounded-lg border-none px-4 py-1.5 text-body-sm font-bold transition-all ${(input.trim() || driveFile) ? 'bg-[var(--color-primary)] text-white hover:bg-[var(--color-primary-hover)]' : 'bg-[var(--color-surface-variant)] text-[var(--color-text-tertiary)] pointer-events-none'}`}>
