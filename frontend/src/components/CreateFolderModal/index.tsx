            ...
            >
                <div className="flex items-center justify-between border-b border-[var(--color-border-light)] px-5 pb-3 pt-4">
                    <div className="flex items-center gap-2">
                        <FolderPlus size={18} className="text-[var(--color-primary)]" />
                        <h2 className="m-0 text-base font-extrabold text-[var(--color-on-surface)]">Create a Folder</h2>
                    </div>
                    <button
                ...
                <div className="px-5 py-4">
                    <label className="mb-1.5 block text-xs font-bold text-[var(--color-text-secondary)]">Folder name</label>
                    <input
                        className="box-border w-full rounded-lg border border-[var(--color-border)] px-3 py-2.5 text-sm text-[var(--color-on-surface)] outline-none transition-colors focus:border-[var(--color-primary)] focus:shadow-[0_0_0_3px_rgba(0,88,190,0.1)]"
                ...
                <div className="flex justify-end gap-2 border-t border-[var(--color-border-light)] px-5 pb-4 pt-3">
                    ...
                    <button
                        className="cursor-pointer rounded-lg border-none bg-[var(--color-primary)] px-4.5 py-2 text-[13px] font-bold text-white transition-colors hover:bg-[var(--color-primary-hover)] disabled:cursor-default disabled:opacity-50"
